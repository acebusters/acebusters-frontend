...
const colors = ['Amber', 'Amethyst', 'Aquamarine', 'Awesome', 'Azure', 'Begonia', 'Beige', 'Black', 'Blue', 'Bronze', 'Brown', 'Burgundy', 'Canary', 'Cherry', 'Coral', 'Cyan', 'Emerald', 'Golden', 'Green', 'Indigo', 'Jade', 'Magenta', 'Mint', 'Mustard', 'Navy', 'Olive', 'Opal', 'Orange', 'Pink', 'Pistachio', 'Red', 'Rose', 'Ruby', 'Salmon', 'Sapphire', 'Scarlet', 'Sepia', 'Silver', 'Turquoise', 'Ultramarine', 'Vermilion', 'Violet', 'White', 'Yellow'];
